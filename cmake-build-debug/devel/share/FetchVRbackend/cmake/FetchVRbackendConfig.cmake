...
if(NOT "/home/jacob/catkin_ws/src/FetchVRbackend/include " STREQUAL " ")
  set(FetchVRbackend_INCLUDE_DIRS "")
  set(_include_dirs "/home/jacob/catkin_ws/src/FetchVRbackend/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'FetchVRbackend' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jacob/catkin_ws/src/FetchVRbackend/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jacob/catkin_ws/src/FetchVRbackend/cmake-build-debug/devel/lib;/home/jacob/catkin_ws/devel/lib;/opt/ros/melodic/lib)
